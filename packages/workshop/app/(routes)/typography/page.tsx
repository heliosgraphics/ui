...
import { Flex, Heading, Separator } from "@heliosgraphics/ui"
import { HeadingInfo } from "./_components/HeadingInfo"
		...
		<Page title="Typography">
			...
			<Flex isColumn gap={6}>
				...
				<HeadingInfo level="paragraph">
					Curabitur metus ex, imperdiet ultricies odio faucibus, ornare viverra est. Vestibulum vitae felis arcu. Fusce sed
					laoreet metus. Sed venenatis id diam non accumsan. Donec elementum ante et lacus scelerisque efficitur. Nam feugiat
					molestie odio, sed sagittis odio lacinia eget. Duis eget porta lorem.
				</HeadingInfo>
				<HeadingInfo level="small">
					Mauris fringilla leo mauris, sed varius sapien egestas et. In ultrices ipsum vitae tincidunt scelerisque. Sed aliquam
					aliquam sapien, eu pellentesque libero fermentum non. Sed semper, lorem at tempus varius, leo odio dictum metus, sit
					amet suscipit massa erat id nisi. Aliquam mollis ex et dolor vestibulum, in blandit quam mattis. Nullam efficitur
					sapien fermentum dolor eleifend, in facilisis eros euismod.
				</HeadingInfo>

		...
		<Flex>
			...
			<Dialog onClose={onDialogToggle} title="Dialog" isOpen={isDialogOpen} isCentered={isCentered}>
				<Flex isColumn={true} gap={8}>
					...
					<Text type="paragraph">
						In the labyrinthine alleys of an ancient city, under the luminescent glow of a crescent moon, a curious wordsmith
						named Theophilius ventured to concoct a lexicon so vast, it could ensnare the essence of the cosmos within its
						alphabetic tapestry. With each stroke of his quill, Theophilius wove together syllables of such exquisite
						complexity, they seemed to dance upon the parchment like shadows flirting with the light.
					</Text>
					{isLong && (
						<>
							<Text type="paragraph">
								His ambition was not merely to create, but to capture the quintessence of every whispering wind, the subtle sigh
								of the sea, and the silent soliloquy of the stars. This monumental manuscript, brimming with alliterations,
								assonances, and arcane analogies, was to be his magnum opus, a typographic tapestry that transcended time.
								Amidst this endeavor, Theophilius discovered peculiar letter-pairs, whose unions produced sounds so unique, they
								could only be described as the auditory equivalent of discovering a new color.
							</Text>
							<Text type="paragraph">
								As twilight draped its velvet mantle over the enchanted forest, a whimsical scribe named Penelope pondered the
								perplexities of parallel universes, each brimming with peculiar phonemes and fantastical flora. Her ambition was
								to capture the symphony of these realms in a grand compendium, a tome so rich in linguistic diversity, it could
								make the very fabric of reality quiver with delight. Penelope’s quill danced feverishly across the parchment,
								scripting sentences that spiraled like vines, entwining the reader in a lush thicket of thought. Her prose was
							...
							<Text type="small" emphasis="secondary">
								...
								embarked upon a linguistic odyssey, charting unknown territories of expression and meaning, where words acted as
								both the map and the terrain, guiding and beguiling the reader through a phantasmagorical journey of discovery.
							</Text>
						</>
					)}
					{hasActions && (
